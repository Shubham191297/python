...
# Below is used to just check if the pattern has any occurences in the string. Checks only for first occurence
# print(re.search(pattern, text, re.IGNORECASE))

# Below is used to find any occurences of the pattern in string and returns the list of occurences.
